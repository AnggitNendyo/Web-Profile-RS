...
const form = useForm({
    ...
    promo_price: props.article.promo_price || '',
});
...
const submit = () => {
    if (isEditing) {
        form.put(route('admin.promos.update', props.article.id));
    } else {
...
<template>
    <Head :title="isEditing ? 'Edit Promo' : 'Tambah Promo'" />
                ...
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="bg-white shadow-sm sm:rounded-xl overflow-hidden">
                                <div class="p-6">
                                    <label for="title" class="block text-sm font-semibold text-gray-700 mb-2">Judul Promo / Paket</label>
                                    <input 
                                        type="text" 
                                        id="title" 
                                        v-model="form.title" 
                                        ...
                                        placeholder="Masukkan nama promo atau paket layanan..."
                                        required
                                    >
                            ...
                            <div class="bg-white shadow-sm sm:rounded-xl overflow-hidden">
                                ...
                                <div class="p-6 space-y-4">
                                    ...
                                    <div class="mb-4 bg-amber-50 p-4 rounded-lg border border-amber-100">
                                        <h4 class="text-sm font-bold text-amber-800 mb-4">Pengaturan Harga</h4>
                                        <div class="space-y-3">
                                            <div>
                                                <label class="block text-xs font-medium text-gray-700 mb-1">Harga Normal (Rp)</label>
                                                <input type="number" v-model="form.price" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-amber-500 focus:ring-amber-500 sm:text-sm" placeholder="Contoh: 500000">
                                            </div>
                                            <div>
                                                <label class="block text-xs font-medium text-gray-700 mb-1">Harga Diskon (Rp) *Opsional</label>
                                                <input type="number" v-model="form.promo_price" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-amber-500 focus:ring-amber-500 sm:text-sm" placeholder="Contoh: 450000">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pt-2 space-y-2">
                                        ...
                                        <Link :href="route('admin.promos.index')" class="w-full inline-flex items-center justify-center px-4 py-2.5 bg-white border border-gray-300 rounded-lg font-semibold text-sm text-gray-500 hover:bg-gray-50 transition">
                                            Batal
                                        </Link>
                                    </div>
                                </div>
