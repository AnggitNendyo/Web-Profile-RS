...
const submit = () => {
    if (isEditing.value) {
        form.put(route('admin.article-categories.update', currentCategory.value.id), {
            onSuccess: () => closeModal(),
        });
    } else {
        form.post(route('admin.article-categories.store'), {
            onSuccess: () => closeModal(),
        });
    }
};
...
const deleteCategory = () => {
    deleteForm.delete(route('admin.article-categories.destroy', currentCategory.value.id), {
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Kategori Artikel</h2>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 overflow-x-auto">
                        <!-- Search Bar -->
                        <div class="mb-4">
                            <SearchInput :model-value="filters?.search" route-name="admin.article-categories.index" placeholder="Cari kategori..." />
                        </div>
        ...
        <Modal :show="isDeleteModalOpen" @close="closeDeleteModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    ...
                    <br><br>
                    <span class="text-red-500" v-if="currentCategory?.articles_count > 0">
                        Peringatan: Kategori ini tidak dapat dihapus karena masih digunakan oleh {{ currentCategory?.articles_count }} artikel.
                    </span>
                </p>
                ...
                <div class="mt-6 flex justify-end">
                    ...
                    <DangerButton
                        class="ml-3"
                        :class="{ 'opacity-25': deleteForm.processing || currentCategory?.articles_count > 0 }"
                        :disabled="deleteForm.processing || currentCategory?.articles_count > 0"
